...
AxiosInstance.interceptors.response.use((response)=>{
    ...
    if (error.response?.status === 401 && !originalRequest.url?.includes("/auth/login") && !originalRequest.url?.includes("/auth/refresh") && !originalRequest.url?.includes("/auth/register") && !originalRequest._retry) {
        ...
        try {
            ...
            const refreshRes = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/api/auth/refresh", undefined, {
                withCredentials: true
            });
...
"[project]/src/widgets/Sidebar/api/index.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getUserInfo = async ()=>{
    return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AxiosInstance"].get(`/auth/user/info`);
};
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$widgets$2f$Sidebar$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/widgets/Sidebar/api/index.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
;
const TopBarMenu = ()=>{
    const { user, setUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$providers$2f$userProvider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUserStore"])((state)=>state);
    let MenuItemsRoles = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$widgets$2f$Sidebar$2f$types$2f$items$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MenuItems"].slice(0, 0);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLayoutEffect"])(()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$widgets$2f$Sidebar$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserInfo"])().then((response)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d9f1f481._.js.map