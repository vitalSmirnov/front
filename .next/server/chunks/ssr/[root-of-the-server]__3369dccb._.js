...
"[project]/src/shared/api/server.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const backendURL = ("TURBOPACK compile-time value", "http://localhost:8000/api") || process.env.API_URL || "http://localhost:3000/api";
const AxiosServerInstance = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: backendURL,
    withCredentials: true
});
AxiosServerInstance.interceptors.request.use(async (config)=>{
    // Read JWT from cookies on the server
    const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$utils$2f$getJwtTokenOnServer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getJwtTokenOnServer"])();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/api/server.ts [app-rsc] (ecmascript)");
;
;
const getServerTicketList = async (payload)=>{
    return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AxiosServerInstance"].get("/tickets", {
        params: payload
    });
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3369dccb._.js.map