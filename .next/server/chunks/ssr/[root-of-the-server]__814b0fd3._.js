...
AxiosServerInstance.interceptors.request.use(async (config)=>{
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$utils$2f$getJwtTokenOnServer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getJwtTokenOnServer"])();
...
const getServerTicketList = async (payload)=>{
    return await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get("/tickets", {
        params: payload,
        withCredentials: true,
        headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__814b0fd3._.js.map