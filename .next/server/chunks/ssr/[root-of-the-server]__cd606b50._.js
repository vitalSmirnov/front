...
"[project]/src/features/LoginUser/api/index.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const loginRequest = async (credentials)=>{
    return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AxiosInstance"].post(`/auth/login`, {
        ...credentials
    });
};
}),
"[project]/src/features/LoginUser/ui/index.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$LoginUser$2f$api$2f$index$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/LoginUser/api/index.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const LoginUserUI = ()=>{
    ...
    const SignInHandler = ()=>{
        router.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$router$2f$routesEnum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RoutesEnum"].REGISTRATION);
    };
    const successAction = async (payload)=>{
        setLoading(true);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$LoginUser$2f$api$2f$index$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginRequest"])(payload).then(()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(error.message || "Ошибка входа, попробуйте позже");
        }).finally(()=>{
            setLoading(false);
        });
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd606b50._.js.map